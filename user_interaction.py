...
+ " --save_dir=" + storing_path\
+ " --restore_dir=" + recovery_path\
...
+ "/train.tfrecord*'\""\
+ " --gin_param=checkpoints_to_keep=" + no_of_checkpoints\
